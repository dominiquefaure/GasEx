...
class UGasExGraph;
class UGasExEdGraph_EdGraph;


class GASEXEDITOR_API FGasExEdGraphEditor : public FAssetEditorToolkit , public FNotifyHook , public FGCObject
{
public:
	FGasExEdGraphEditor();
	virtual ~FGasExEdGraphEditor();
	 ...
	 */
	void InitGraphEditor( const EToolkitMode::Type Mode , const TSharedPtr<IToolkitHost>& InitToolkitHost , UGasExGraph* InActionGraph );
	...
	UGasExEdGraph_EdGraph* GetAbilityEditorGraph();
