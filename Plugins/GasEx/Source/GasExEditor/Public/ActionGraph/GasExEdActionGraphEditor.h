...
class UGasExEdActionGraph_EdGraph;


class GASEXEDITOR_API FGasExEdActionGraphEditor : public FAssetEditorToolkit , public FNotifyHook , public FGCObject
{
public:
	FGasExEdActionGraphEditor();
	virtual ~FGasExEdActionGraphEditor();
	 ...
	 */
	void InitGraphEditor( const EToolkitMode::Type Mode , const TSharedPtr<IToolkitHost>& InitToolkitHost , UGasExActionGraph* InActionGraph );
	...
	UGasExEdActionGraph_EdGraph* GetActionEditorGraph();
...
private:
	...
	UGasExActionGraph* ActionGraphEdited;
