...
class UGxEdActionGraph_EdGraph;


class GXACTIONSEDITOR_API FGxEdActionGraphEditor : public FAssetEditorToolkit , public FNotifyHook , public FGCObject
{
public:
	FGxEdActionGraphEditor();
	virtual ~FGxEdActionGraphEditor();
	 ...
	 * @param	InActionGraph				The graph model to edit
	 */
	void InitGraphEditor( const EToolkitMode::Type Mode , const TSharedPtr<IToolkitHost>& InitToolkitHost , UGxActionGraph* InActionGraph );


	/** Get the graph being edited */
	UGxEdActionGraph_EdGraph* GetCurrentGraphEditor();
...
private:
	...
	/** The Action Graph model this editor handles */
	TObjectPtr<UGxActionGraph> GraphEdited;
